class BubbleChart {
    ...
    update() {
        ...
        self.cvalue = d => d.Name;
        self.xvalue = d => d.Age;
        self.yvalue = d => d.Potential;
        self.rvalue = d => d.HeadingAccuracy/10;
     ...
     render() {
        ...
        circles
            .on('mouseover', (e,d) => {
                d3.select('#tooltip')
                    .style('opacity', 1)
                    .html(`<div class="tooltip-label">${d.Name}</div>Population:${d.Potential}<br>Bed:${d.Age}<br>Infected:${d.HeadingAccuracy
                    }`);
            })
            .on('mousemove', (e) => {
                const padding = 10;
