class BarChart {
    ...
    init() {
        ...
        self.xaxis = d3.axisBottom(self.xscale)
            .ticks(['L. Messi','Cristiano Ronaldo','Neymar Jr','De Gea','K. De Bruyne','E. Hazard','L. Modri','L. Surez','Sergio Ramos','J. Oblak','R. Lewandowski','T. Kroos','D. Godn','David Silva','N. Kant','P. Dybala','H. Kane','A. Griezmann','M. ter Stegen','T. Courtois','Sergio Busquets','E. Cavani','M. Neuer','S. Agero','G. Chiellini','K. Mbapp','M. Salah','Casemiro','J. Rodrguez','L. Insigne','Isco','C. Eriksen','Coutinho','P. Aubameyang','M. Hummels','Marcelo','G. Bale','H. Lloris','G. Higua'])
            .tickSizeOuter(0);
    ...
    update() {
        ...
        const data_map = d3.rollup( self.data, v => v.length, d => d.Name );
